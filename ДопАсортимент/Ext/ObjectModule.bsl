...
Функция СведенияОВнешнейОбработке() Экспорт
    ...
    РегистрационныеДанные.Вставить("Наименование","Доп.ассортимент (бюджет, продажи, движение товаров)");
    РегистрационныеДанные.Вставить("БезопасныйРежим", Ложь);
    РегистрационныеДанные.Вставить("Версия", "1.1");
    РегистрационныеДанные.Вставить("Вид", "ДополнительныйОтчет");
    РегистрационныеДанные.Вставить("ИмяОбъекта","Доп.ассортимент (бюджет, продажи, движение товаров)");
    РегистрационныеДанные.Вставить("Информация", "Доп.ассортимент (бюджет, продажи, движение товаров)");
    ...
    строкаКоманды.Идентификатор = "101";
    строкаКоманды.Представление = "Доп.ассортимент (бюджет, продажи, движение товаров)";
